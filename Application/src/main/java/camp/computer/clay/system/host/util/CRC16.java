package camp.computer.clay.system.host.util;
 ...
 * - Polynomial Representations of CRCs
...
public class CRC16 {
    ...
    // Polynomial representations of CRCs. Used to seed the generator.
    // Reference:
    ...
    public static final int CRC_16_CCITT_RECIPROCAL_REVERSE = 0x8810; // CCITT reverse X16+X11+X4+1   (CRC-16-CCITT)

    public static int DEFAULT_POLYNOMIAL = CRC_16_IBM_NORMAL;

    // Generated by `./pycrc.py --algorithm=table-driven --construct=crc-16 --generate=c`
    ...
    public int calculate (byte[] data, int initialCRCValue) {
        ...
        for (int index = 0; index < data.length; index++) {
            ...
            crc = ((lookupTable[(crc ^ dataByte) & 0xFF] ^ (crc >> 8)) & 0xFFFF);
        }
