...
//        // </FORM_CONFIGURATION>
//
//        // TODO: Move Space/Base this into Space or _Ecology (in Space) --- maybe combine Space+_Ecology
...
//    }
    ...
    private void simulateBase() {

        // <FORM_CONFIGURATION>
        // TODO: Read this from the device (or look up from base UUID). It will be encoded on
        // TODO: (cont'd) the device.
        final int PORT_COUNT = 12;
        // </FORM_CONFIGURATION>
...
//        scene.addImage(baseImage, "bases");
    ...
    /**
     * Adds the specified unit to Clay's operating space.
     */
...
//                ApplicationView.getDisplay().mapView.getSpace().simulateBase(new Base());
...
//
//        // Discover getStartAction device
