...
////                Impression action = new Impression(selectedBehaviorScript);
//                Impression action = getClay().getCache().getActions().get(selectedBehaviorIndex);
...
//            // Create action based on action script
//            Log.v("Content_Manager", "> Creating action");
////            Impression action = new Impression("so high");
...
////            getClay().getStore().storeAction(action);
//            ArrayList<Impression> children = new ArrayList<Impression>();
...
//            Impression action = getClay().getStore().getActionComposition(children);
//
...
////            Impression behavior = new Impression("so so high");
