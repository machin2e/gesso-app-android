...
//            Log.v("UDP", "OLD_Clock since getLastEvent dispatch: " + (currentTime.getTime() - timeLastSentMessage.getTime()));
//            Log.v("UDP", " OLD_Clock since getLastEvent message: " + (currentTime.getTime() - outgoingMessage.getTimeLastSent().getTime()));
...
//            Log.v ("UDP_Time", "OLD_Clock since retry (must be > " + Message.RETRY_SEND_PERIOD + " ms): " + (currentTimeMillis - outgoingMessage.getTimeLastSent().getTime ()));
