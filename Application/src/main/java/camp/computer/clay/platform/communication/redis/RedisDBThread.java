...
public class RedisDBThread implements Runnable {

    private String SERVER_URI = "pub-redis-14268.us-east-1-3.3.ec2.garantiadata.com";
    private int SERVER_PORT = 14268;

//    private Jedis jedis = null;

    public RedisDBThread(Jedis jedis) {
        Log.v("Redis", "RedisSubThread");
//        this.jedis = jedis;
    }

    public RedisDBThread() {
...
//        System.out.printf("Enter the channel name:");
        ...
        Jedis jedis = new Jedis(SERVER_URI, SERVER_PORT);
        jedis.auth("testdb");
...
//        }
    ...
    public void start() {
//        Jedis jedis = null;
        new RedisDBThread.JedisConnectToDatabaseTask().execute("pub-redis-14268.us-east-1-3.3.ec2.garantiadata.com:14268");
...
//                Log.v("Redis", "called publish");
                ...
                new Thread(new RedisDBThread(jedis)).start();
