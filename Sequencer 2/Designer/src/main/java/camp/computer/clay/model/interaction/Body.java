...
public class Body extends _Actor {
    ...
    private void onTouchListener(TouchInteractivity touchInteractivity, TouchInteraction touchInteraction) {
        ...
        Image touchedImage = perspective.getVisualization().getTarget(touchInteraction.getPosition());
        touchInteraction.setTarget(touchedImage);

//        if (perspective.hasFocus()) {
//
//            if (perspective.getFocus().isType(FormImage.TYPE, PortImage.TYPE, PathImage.TYPE)) {
//
//                if (touchInteraction.isTouching() && touchInteraction.getTarget().isType(PortImage.TYPE)) {
////                    Log.v("Interaction", "BUH");
////                    perspective.InteractionfocusOnPort((PortImage) touchInteraction.getTarget());
//                }
//            }
//
//            if (perspective.getFocus().isType(PortImage.TYPE, PathImage.TYPE)) {
//
//                if (touchInteraction.isTouching() && touchInteraction.getTarget().isType(PathImage.TYPE)) {
////                    perspective.InteractionfocusOnPath((PathImage) touchInteraction.getTarget());
//                }
//            }
//        }
//
//        // Reset object interaction state
//        if (!perspective.hasFocus() || perspective.getFocus().isType(FormImage.TYPE, PortImage.TYPE)) {
//
//            if (touchInteraction.isTouching() && touchInteraction.getTarget().isType(FormImage.TYPE)) {
////                perspective.InteractionfocusOnForm((FormImage) touchInteraction.getTarget());
//            }
//
//        }
//
//        if (!perspective.hasFocus() || perspective.getFocus().isType(FormImage.TYPE, PortImage.TYPE, PathImage.TYPE)) {
//
...
//        }
    ...
    public void onHoldListener(TouchInteractivity touchInteractivity, TouchInteraction touchInteraction) {
        ...
        Image targetImage = perspective.getVisualization().getTarget(touchInteraction.getPosition());
        ...
        if (touchInteraction.isTouching()) {
            ...
            if (touchInteraction.getTarget().isType(FormImage.TYPE)) {
        ...
        if (touchInteractivity.isHolding[touchInteraction.pointerIndex]) {
            ...
            if (touchInteraction.isTouching()) {
                ...
                if (touchInteraction.getTarget().isType(FormImage.TYPE)) {
                    ...
                    FormImage formImage = (FormImage) touchInteraction.getTarget();
    ...
    private void onReleaseListener(TouchInteractivity touchInteractivity, TouchInteraction touchInteraction) {
        ...
        if (touchInteraction.isTouching()) {
            ...
            if (touchInteraction.getTarget().isType(FormImage.TYPE)) {
                ...
                if (touchInteractivity.getFirst().isTouching() && touchInteractivity.getFirst().getTarget().isType(FormImage.TYPE)) {
                    // Form
                    FormImage formImage = (FormImage) touchInteraction.getTarget();
                    formImage.touch(touchInteraction);
                }
                ...
                for (FormImage nearbyFormImage : perspective.getVisualization().getFormImages()) {
                    ...
                    if (distanceToFormImage < nearbyFormImage.boardHeight + 50) {
...
//                touchInteraction.setTarget(touchInteractivity.getFirst().getTarget());
//                touchInteraction.setType(TouchInteraction.Type.RELEASE);
//                Log.v("onHoldListener", "Source port: " + touchInteraction.getTarget());
...
//            for (FormImage formImage : perspective.getVisualization().getFormImages()) {
...
//            Point centroidPosition = perspective.getVisualization().getImages().filterType(FormImage.TYPE).calculateCentroid();
