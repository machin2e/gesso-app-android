...
//    private State behaviorState;
    ...
    /**
     * The list of actions that constitute this behavior, if any. This list is empty for basic
     * actions. Behaviors for which this list is not empty are compositions of basic actions
