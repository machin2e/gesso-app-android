...
public class EventHolderAdapter extends BaseAdapter {
     ...
     * @param events
     */
    public EventHolderAdapter(Context context, int resource, ArrayList<EventHolder> events) {
        this.inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.resource = resource;
        this.eventHolders = events;
    }

    /**
     * Return the size of the eventHolders set.
     */
    public int getCount() {
    ...
    /**
     * Return an object in the eventHolders set.
     */
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                drawTimelineSegment(v, eventHolders.get(position), height);
